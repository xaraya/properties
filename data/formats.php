...
function datetime_formats()
{
    ...
    $formats[1] = array('id' => 1, 'name' => 'Universal - long', 'format' => 'Y-m-d H:i', 'useoffset' => 0);
    $formats[2] = array('id' => 2, 'name' => 'US - short', 'format' => 'm-d-Y h:i A', 'useoffset' => 0);
    $formats[2] = array('id' => 2, 'name' => 'US - long', 'format' => 'm-d-Y H:i A', 'useoffset' => 0);
    $formats[3] = array('id' => 3, 'name' => 'Euro - short', 'format' => 'd.m.Y h:i', 'useoffset' => 0);
    $formats[3] = array('id' => 3, 'name' => 'Euro - long', 'format' => 'd.m.Y H:i', 'useoffset' => 0);
