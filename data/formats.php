...
function datetime_formats()
{
    ...
    $formats[2] = array('id' => 2, 'name' => 'Universal - long', 'format' => 'Y-m-d H:i', 'useoffset' => 0);
    $formats[3] = array('id' => 3, 'name' => 'US - short', 'format' => 'm-d-Y h:i A', 'useoffset' => 0);
    $formats[4] = array('id' => 4, 'name' => 'US - long', 'format' => 'm-d-Y H:i A', 'useoffset' => 0);
    $formats[5] = array('id' => 5, 'name' => 'Euro - short', 'format' => 'd.m.Y h:i', 'useoffset' => 0);
    $formats[6] = array('id' => 6, 'name' => 'Euro - long', 'format' => 'd.m.Y H:i', 'useoffset' => 0);
